    ...
    <script>
        $(document).ready(function() {
            ...
            $.each(data, function(index, value) {
                if (count === 0) {
                    document.getElementById("here").innerHTML += "<h1>Вы выбрали</h1>";
                }
                document.getElementById("here").innerHTML += "<h2>" + value + "</h2>";
                count++;
            });
            let sum = 500 * count;
            document.getElementById("payhere").innerHTML += "<h3>К оплате " + sum + " рублей.</h3>";
    ...
    <div style="text-align: center;">
        <form action="pay" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" required class="form-control" id="email" name="email" placeholder="E-mail" title="Введите email...">
            </div>
            <div style="text-align: right;">
                <div id="payhere">
                </div>
            </div>
            <button type="submit" class="btn btn-success" onclick="valida   te()">Оплатить</button>
        </form>
    </div>
</div>
</body>
